...
- the per-host circuit-breaker plugins (Claude Code / Codex / OpenClaw).
...
## Tool flow (agent tool calls)

These endpoints are used by the per-host circuit-breaker plugin that intercepts tool calls.
